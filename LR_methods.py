...
class ReduceLROnPlateau(object):
    ...
    def __init__(self, optimizer, mode='min', factor=0.1, patience=10,
                 ...
                 cooldown=0, min_lr=0, eps=1e-8, trace_func=None):
    ...
    def step(self, metrics, epoch=None):
        ...
        if self.is_better(current, self.best):
            ...
            self.trace_func.info('\tPatience counter: {} out of {}'.format(self.num_bad_epochs,self.patience))
    ...
    def _reduce_lr(self, epoch):
        for i, param_group in enumerate(self.optimizer.param_groups):
            ...
            if old_lr - new_lr > self.eps:
                ...
                if self.verbose:
                    self.trace_func.info('\tEpoch {:5d}: reducing learning rate'
                          ' of group {} to {:.1e}.'.format(epoch, i, new_lr))
